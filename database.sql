...
UPDATE "accounts" SET "account_balance" = 10.00, "transactions_attempted" = 10.00 WHERE "user_id" = 5;
--	4.	Select all users that have attempted 9 or more transactions.
SELECT * FROM "accounts" WHERE "transactions_attempted" >=9 AND "transactions_completed" >=9;
...
--	8.	Add a new record.
INSERT INTO "accounts" ( "username", "city", "transactions_completed", "transactions_attempted", "account_balance") VALUES ( 'minneapolis', 'st. paul', '500', '30000', '1000000000');
...
SELECT * FROM "accounts" WHERE "transactions_completed" < 4 AND "city" ILIKE '%phoenix%' OR "city" ILIKE '%miami%';
